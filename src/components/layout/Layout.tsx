...
/** Interpolates between two numeric values for smooth canvas animation. */
function lerpN(a: number, b: number, t: number) {
  return a + (b - a) * t;
}

/** Interpolates two RGBA colors for active and inactive grid states. */
function lerpColor(
...
/**
 * Renders the animated canvas background behind application content.
 * It connects to App through children, optional className, and globalColor props.
 * @param props Content and visual configuration supplied by the parent component.
 */
...
export function Layout({
    ...
    /** Calculates cursor and ripple displacement for one grid intersection. */
    ...
    /** Draws the background, warped grid, nodes, and ripple rings on the canvas. */
    const draw = useCallback(
        ...
        // ── Grid lines ────────────────────────────────────────────────────────
        /** Draws one grid segment using proximity-based color and width. */
    ...
    /** Advances the smoothed pointer position and renders one animation frame. */
    ...
    useEffect(() => {
        ...
        /** Resizes the canvas to match the current browser viewport. */
        const setSize = () => {
        ...
        /** Stores the latest pointer position for the animated grid. */
        const onMouseMove = (e: MouseEvent) => {
        targetMouseRef.current = { x: e.clientX, y: e.clientY };
        };

        /** Starts a visual ripple at the most recent click position. */
        ...
        /** Schedules the next canvas animation frame. */
    ...
    /** Renders the fixed canvas layer and the content supplied by the parent. */
    return (
        <div
